...
class Content(models.Model):
    ...
    like_users = models.ManyToManyField(UserProfile, blank=True, related_name='like_contents')
    scrap_users = models.ManyToManyField(UserProfile, blank=True, related_name='scrap_contents')
